  ...
  return (
    <div className={`min-h-screen cursor-none font-light transition-colors duration-300 ${
      ...
      >
        <div 
          className={`
            border rounded-lg p-4 mb-2 transform transition-all duration-300 
        ...
        >
          <div className="space-y-2">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className={`block hover:opacity-50 transition-opacity cursor-none ${
                isDark ? 'text-gray-300' : 'text-gray-600'
              }`}
            >
              <span className="font-mono">⌥</span> github.com/vedaangh
            </a>
            <a 
